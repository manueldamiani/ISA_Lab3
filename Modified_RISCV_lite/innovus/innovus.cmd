...
#  Created on Mon Feb 22 01:06:55 2021                
#                                                     
#######################################################
...
set init_top_cell RISCV_lite
set init_verilog ../netlist/RISCV_lite.v
...
set init_design_settop 1
set init_top_cell RISCV_lite
set init_verilog ../netlist/RISCV_lite_post_syn.v
set init_lef_file /software/dk/nangate45/lef/NangateOpenCellLibrary.lef
set init_gnd_net VSS
set init_pwr_net VDD
init_design
...
saveDesign Modified_RISCV_lite
reset_parasitics
extractRC
rcOut -setload RISCV_lite.setload -rc_corner my_rc
rcOut -setres RISCV_lite.setres -rc_corner my_rc
rcOut -spf RISCV_lite.spf -rc_corner my_rc
rcOut -spef RISCV_lite.spef -rc_corner my_rc
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -pathReports -slackReports -numPaths 50 -prefix RISCV_lite_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix RISCV_lite_postRoute -outDir timingReports
...
reportGateCount -level 5 -limit 100 -outfile RISCV_lite.gateCount
saveNetlist Modified_RISCV_lite_postroute.v
all_hold_analysis_views 
all_setup_analysis_views 
write_sdf  -ideal_clock_network Modified_RISCV_lite.sdf
